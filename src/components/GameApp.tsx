...
export function GameApp() {
  ...
  const values = useControls("Physics", {
    ...
    transitLaunchForce: {
      value: tuning.transitLaunchForce,
      min: 100,
      max: 1600,
      step: 10,
    },
    transitEngineBurnSeconds: {
      value: tuning.transitEngineBurnSeconds,
      min: 0.1,
      max: 3,
      step: 0.1,
    },
    transitLaunchAngle: {
      value: tuning.transitLaunchAngle,
      min: -Math.PI / 4,
      max: Math.PI / 4,
      step: 0.01,
    },
    transitPlayableAltitude: {
      value: tuning.transitPlayableAltitude,
      min: 10,
      max: 120,
      step: 1,
    },
    transitMaxHorizontalSpeed: {
      value: tuning.transitMaxHorizontalSpeed,
      min: 1,
      max: 30,
      step: 0.5,
    },
    transitHandOffDistance: {
      value: tuning.transitHandOffDistance,
      min: 20,
      max: 400,
      step: 5,
    },
    transitHandOffVerticalSpeed: {
      value: tuning.transitHandOffVerticalSpeed,
      min: 2,
      max: 60,
      step: 1,
    },
    transitMaxSeconds: {
      value: tuning.transitMaxSeconds,
      min: 1,
      max: 30,
      step: 0.5,
    },
